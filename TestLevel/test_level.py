...
class TestLevel:
    ...
    def run(self):
        ...
        # ============================================================
        # Tutaj jest offset zeby hitbox byl w srodku

        # apply offset to center the PNG on the hitbox
        image_offset = pygame.Vector2(-35, -55)  # tweak these values
        sprite_rect.x += image_offset.x
        sprite_rect.y += image_offset.y
        
        # ============================================================
        
        # draw the sprite
        self.display.blit(self.player.sprite, sprite_rect)
